# This Makefile is for the Net::UCP::IntTimeout extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Net/UCP/IntTimeout.pm]
#     AUTHOR => q[Marco Romano <nemux@cpan.org>]
#     NAME => q[Net::UCP::IntTimeout]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Net/UCP/IntTimeout.pm]
#     test => { TESTS=>q[t/Net-UCP-IntTimeout.t] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Net/UCP/IntTimeout.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DIRFILESEP)Config.pm $(PERL_INC)$(DIRFILESEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Net/UCP
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Net/UCP
...
TO_INST_PM = lib/Net/UCP/IntTimeout.pm

PM_TO_BLIB = lib/Net/UCP/IntTimeout.pm \
...
DISTNAME = Net-UCP-IntTimeout
DISTVNAME = Net-UCP-IntTimeout-0.03
...
manifypods : pure_all  \
	lib/Net/UCP/IntTimeout.pm \
	lib/Net/UCP/IntTimeout.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW)\
	  lib/Net/UCP/IntTimeout.pm $(INST_MAN3DIR)/Net::UCP::IntTimeout.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(MAKEFILE_OLD) $(FIRST_MAKEFILE) blib/lib/Net/UCP/IntTimeout.pm
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Net-UCP-IntTimeout' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.03' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Net/UCP/IntTimeout.pm' >> META.yml
...
TEST_FILE = test.pl
TEST_FILES = t/Net-UCP-IntTimeout.t
TESTDB_SW = -d
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl Timeout Manager for Net::UCP Module</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Marco Romano &lt;nemux@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/Net/UCP/IntTimeout.pm blib/lib/Net/UCP/IntTimeout.pm 
	$(NOECHO) $(TOUCH) $@
